...
private:
    ...
    pcl::PointCloud<PointType>::Ptr nongroundCloud;         //@@@@@@@@@@@@@@@@@@@@ cone에는 없음 @@@@@@@@@@@@@@@@@
...
public:
    ImageProjection():
        ...
        pubConeArray = nh.advertise<visualization_msgs::MarkerArray>("/cones", 10);  //@@@@@@@@@@@@@@@@@@@@ xx에는 없음 @@@@@@@@@@@@@@@@@
        ...
        pubnongroundCloud = nh.advertise<sensor_msgs::PointCloud2> ("/nongroundcloud", 1); //@@@@@@@@@@@@@@@@@@@@ xx에는 없음 @@@@@@@@@@@@@@@@@
    ...
    void allocateMemory(){
        ...
        nongroundCloud.reset(new pcl::PointCloud<PointType>()); //@@@@@@@@@@@@@@@@@@@@ xx에는 없음 @@@@@@@@@@@@@@@@@
    ...
    void publishCloud(){
        ...
        if (pubnongroundCloud.getNumSubscribers() != 0){
            ...
            laserCloudTemp.header.stamp = cloudHeader.stamp;
            laserCloudTemp.header.frame_id = "base_laser";
            pubRoiCloud.publish(laserCloudTemp);    //pubRoi에 쏨..
        }
        //@@@@@
